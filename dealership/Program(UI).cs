  ...
  public class Program 
  {
    public static void Main()//below weve created four object instances of our class
    {
      ...
      */
      ...
      //lesson 10 example
      // Console.WriteLine(yugo.MakeModel);//here we see what the naming conventing does before we use our property
      // yugo.MakeModel = "Worst Car Ever";// we now call on our property and redefine get and its value
      // Console.WriteLine(yugo.MakeModel);//this will out put worst car ever in the console
